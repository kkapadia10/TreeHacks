...
import { WordCountDecorator as EaselWordCountDecorator } from '../../../../../../../base/form/input/decorators/word_count_decorator';
/** 
 ...
 */
export function WordCountDecorator(props) {
    return _jsx(EaselWordCountDecorator, { max: props.max });
}
