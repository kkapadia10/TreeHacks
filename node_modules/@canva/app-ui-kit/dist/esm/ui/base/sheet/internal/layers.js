...
export class Layers {
  ...
  addSheet(sheet) {
    ...
    if (!layer || layer.forced || layer.from !== from || sheet.props.forceLayer) {
      const layerLevel = this.calculateNewLayerLevel(onBottom, (_a = sheet.props.layerLevel) !== null && _a !== void 0 ? _a : LayerLevel.PINS);
      layer = new Layer(from, !!sheet.props.forceLayer, sheet.window, layerLevel);
      ReactDOM.render(_jsx(EaselProvider, {
