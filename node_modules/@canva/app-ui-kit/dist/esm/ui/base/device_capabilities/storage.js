...
export async function hasStorageAccess(document = _document, window = _window) {
...
export function hasCookiesAccess(document = _document) {
...
export async function requestStorageAccess(document = _document, window = _window) {
...
export function hasLocalStorageAccess(window = _window) {
...
export function hasWebStorageAccess(window = _window, webStorageAPIName = 'localStorage') {
...
export function getLocalStorageIfAvailable(window = _window) {
    if (!window || !hasLocalStorageAccess(window)) {
        return;
    }
    return window.localStorage;
}
export function getSessionStorageIfAvailable(window = _window) {
