...
export const Description = ({ tone = 'neutral', children, id }) => {
    ...
    if (hasChildrenArray) {
        return (_jsx("div", { id: id, className: styles.list, role: role, "aria-atomic": false, children: React.Children.map(children, (child, i) => (_jsx("p", { className: className, children: child }, i))) }));
    }
    return (_jsx("p", { id: id, className: className, role: role, children: children }));
};
