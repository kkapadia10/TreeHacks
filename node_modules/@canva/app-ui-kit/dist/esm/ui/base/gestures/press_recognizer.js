...
export class PressRecognizer {
    constructor(opts) {
        ...
        this.timeout = () => {
            ...
            if (this.state) {
                ...
                (_b = (_a = this.opts).onStart) === null || _b === void 0 ? void 0 : _b.call(_a, getCommonEventProperties(this.state.pointer.start));
            }
        };
    ...
    onPointerMove(pointers, allPointers) {
        ...
        if (this.state && !this.isWithinMaxDistance()) {
            ...
            state.recognized && ((_b = (_a = this.opts).onCancel) === null || _b === void 0 ? void 0 : _b.call(_a, getCommonEventProperties(state.pointer.current)));
        }
    }
    onPointerUp(pointer) {
        var _a, _b, _c, _d;
        if (this.state) {
            ...
            if (state.recognized) {
                withinMaxDistance
                    ? (_b = (_a = this.opts).onEnd) === null || _b === void 0 ? void 0 : _b.call(_a, getCommonEventProperties(pointer.current))
                    : (_d = (_c = this.opts).onCancel) === null || _d === void 0 ? void 0 : _d.call(_c, getCommonEventProperties(pointer.current));
            }
        }
    }
    onUnmount() {
        ...
        if ((_a = this.state) === null || _a === void 0 ? void 0 : _a.recognized) {
            (_c = (_b = this.opts).onCancel) === null || _c === void 0 ? void 0 : _c.call(_b, getCommonEventProperties(this.state.pointer.current));
        }
    }
    isWithinMaxDistance() {
        var _a;
