...
exports.calculateNextStateImpl = exports.isVerticalDirection = exports.BottomSheetDragBehavior = void 0;
const tslib_1 = require("tslib");
const preconditions_1 = require('../../../../base/preconditions');
const mobx = require("mobx");
const gesture_recognizer_1 = require('../../gestures/gesture_recognizer');
...
class BottomSheetDragBehavior {
  ...
  constructor(_window, onStateChanged, peekSizePx = DEFAULT_SHEET_PEEK_HEIGHT, transparentOverlayOnPeek = false, offsetForViewportHeight, onPanning, calculateNextState = calculateNextStateImpl) {
    ...
    this.recognizer = new gesture_recognizer_1.PanRecognizer({
      minDistance: 4,
      direction: 'vertical',
      onStart: () => {
  ...
  onEventStart() {
    ...
    if (this.hasPeekState) {
      preconditions_1.Preconditions.checkArgument(this.midSize > 0, 'the peek height is not defined');
    }
    preconditions_1.Preconditions.checkArgument(this.maxSize > 0, 'the max height is not defined');
  }
  onMoveVertical(e) {
  ...
  get snapSize() {
    ...
    switch (this.sheetState) {
      ...
      case 'expanded':
        return this.maxSize;
      default:
        throw new preconditions_1.UnreachableError(this.sheetState);
    }
  }
...
exports.BottomSheetDragBehavior = BottomSheetDragBehavior;
function isVerticalDirection(e) {
  return e.direction === 'up' || e.direction === 'down' || e.direction === 'none';
}
exports.isVerticalDirection = isVerticalDirection;
function calculateNextStateImpl(
  {
    direction,
    deltaSize,
    velocity,
  ...
  switch (direction) {
    ...
    default:
      throw new preconditions_1.UnreachableError(direction);
  }
}
exports.calculateNextStateImpl = calculateNextStateImpl;