...
exports.Lightness = exports.Difference = exports.Conversion = exports.CssColors = exports.HslColor = exports.XyzColor = exports.HclColor = exports.LabColor = exports.RgbaColor = exports.RgbColor = void 0;
...
class RgbColor {
    constructor(r, g, b) {
        ...
        this.g = g;
        this.b = b;
        preconditions_1.Preconditions.checkArgument(0 <= r && r <= 255, 'invalid r: {}', r);
        preconditions_1.Preconditions.checkArgument(0 <= g && g <= 255, 'invalid g: {}', g);
        preconditions_1.Preconditions.checkArgument(0 <= b && b <= 255, 'invalid b: {}', b);
    }
...
class RgbaColor {
    constructor(r, g, b, a) {
        ...
        preconditions_1.Preconditions.checkArgument(0 <= g && g <= 255, 'invalid g: {}', g);
        preconditions_1.Preconditions.checkArgument(0 <= b && b <= 255, 'invalid b: {}', b);
        preconditions_1.Preconditions.checkArgument(0 <= a && a <= 1, 'invalid a: {}', a);
    }
...
class LabColor {
    constructor(l, a, b) {
        ...
        this.a = a;
        this.b = b;
        preconditions_1.Preconditions.checkArgument(0 <= l && l <= 100, '{}', l);
    }
}
...
class HslColor {
    constructor(h, s, l) {
        ...
        this.s = s;
        this.l = l;
        preconditions_1.Preconditions.checkArgument(0 <= s && s <= 100, 'invalid s: {}', s);
        preconditions_1.Preconditions.checkArgument(0 <= l && l <= 100, 'invalid l: {}', l);
        this.h = normalizeHue(h);
    }
}
...
class Conversion {
    ...
    static hexToRgb(c) {
        preconditions_1.Preconditions.checkArgument(/^#[0-9a-f]{6}$/.test(c), 'non-compliant hex code');
...
class Difference {
    ...
    static de2000(color1, color2, kL = 1, kC = 1, kH = 1) {
        preconditions_1.Preconditions.checkArgument(kL > 0);
        preconditions_1.Preconditions.checkArgument(kC > 0);
        preconditions_1.Preconditions.checkArgument(kH > 0);
