...
function useTouchScroll({ panControls }) {
    ...
    const onTouchStart = (0, stable_function_1.useStableFunction)((event) => {
    ...
    const onTouchMove = (0, stable_function_1.useStableFunction)((event) => {
        let currentTouch;
    ...
    const onScroll = (0, stable_function_1.useStableFunction)((event) => {
    ...
    const onTouchEnd = (0, stable_function_1.useStableFunction)(() => {
    ...
    const touchScrollRef = (0, stable_function_1.useStableFunction)(element => {
...
exports.useTouchScroll = useTouchScroll;
