...
exports.SwatchMessages = {
    ...
    colorTitleWithNameAndCmykInfo: (colorName, colorRgbValue, colorCmykInfo) => (0, strings_1.formatId)("ANJ3MQ", [colorName, colorRgbValue, colorCmykInfo], "{0} {1} {2}"),
    colorTitleWithCmykInfo: (colorRgbValue, colorCmykInfo) => (0, strings_1.formatId)("aOOdWg", [colorRgbValue, colorCmykInfo], "{0} {1}"),
    colorTitleWithName: (colorName, colorRgbValue) => (0, strings_1.formatId)("0FCfTQ", [colorName, colorRgbValue], "{0} {1}"),
