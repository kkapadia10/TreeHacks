...
exports.isDesktopAppSupported = void 0;
const _navigator = typeof navigator !== 'undefined' ? navigator : undefined;
function isDesktopAppSupported(navigator = _navigator) {
    var _a;
    if (navigator == null) {
        return false;
    }
...
exports.isDesktopAppSupported = isDesktopAppSupported;
