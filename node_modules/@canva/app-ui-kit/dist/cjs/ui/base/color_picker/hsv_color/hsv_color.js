...
class HsvColor {
    constructor(h, s, v, alpha = 1) {
        ...
        this.v = v;
        this.alpha = alpha;
        preconditions_1.Preconditions.checkArgument(0 <= s && s <= 1, '0 <= saturation <= 1: {}', s);
        preconditions_1.Preconditions.checkArgument(0 <= v && v <= 1, '0 <= value <= 1: {}', v);
    ...
    static fromHexString(hex) {
        ...
        const rgb = color_1.RgbColor.fromHexString(hex);
        const r = rgb.r / 255;
        const g = rgb.g / 255;
        const b = rgb.b / 255;
        const max = Math.max(r, g, b);
    ...
    toRgb() {
        ...
        return new color_1.RgbColor(r, g, b);
    }
    toRgba() {
        const { r, g, b } = this.toRgb();
        return new color_1.RgbaColor(r, g, b, this.alpha);
    }
    equals(that) {
