...
export declare const AudioContext: React.Context<AudioContextValue | undefined>;
/**
 * 
 ...
 */
export declare const AudioContextProvider: (props: React.PropsWithChildren<{}>) => import("react/jsx-runtime").JSX.Element;
